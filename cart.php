  ...
  echo $_SESSION['message'];
		...
		?>
              ...
              <tr>
                ...
                <td><img src="pimg/<?= $row['product_image'] ?>" width="50"></td>
                ...
                <td>
                  <input type="number" class="form-control itemQty" value="<?= $row['qty'] ?>" style="width:75px;" min="1" onkeyup="if(this.value<0){this.value= this.value * -1}">
                </td>
                <td>RM</i>&nbsp;&nbsp;<?= number_format($row['total_price'],2); ?></td>
                <td>
                  <a href="action.php?remove=<?= $row['id'] ?>" class="text-danger lead" onclick="return confirm('Are you sure want to remove this item?');">Remove</i></a>
                </td>
              </tr>
              ...
              <tr>
                ...
                <td>
                  <a <?php echo"href='checkout.php?check&cid=".$_SESSION['cid']."'"; ?> class="btn btn-info <?= ($grand_total > 1) ? '' : 'disabled'; ?>">&nbsp;&nbsp;Checkout</a>
