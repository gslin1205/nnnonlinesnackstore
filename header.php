				...
				&nbsp;&nbsp;&nbsp;&nbsp;
					...
					<?php
                        ...
                        if(isset($_SESSION["cid"])){
                            ...
                            echo '
                            <div class="dropdownn">
								<a href="#" class="dropdownn" id="nav-cta" style="text-decoration:none;"><i class="fa fa-user" aria-hidden="true"></i> HI '.$row["cfname"].'</a>
                                ...
                                echo '
                                <div class="dropdownn">
                                <a href="#" class="dropdownn" id="nav-cta" style="text-decoration:none;" ><i class="fa fa-user" aria-hidden="true"></i></a>
                                  <div class="dropdownn-content">
